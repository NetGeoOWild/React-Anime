...
export function Footer() {
  return (
    <footer className="bg-mist-400 text-black dark:bg-[#161515] dark:text-white">
      <div className="container">
        <div className="flex items-center justify-between pt-8.75 max-sm:flex-wrap">
          <div className="max-sm:mb-8 max-sm:w-full">
            <Logo />
            <h6 className="font-aubrey pt-2.5 text-lg max-sm:text-sm">
              Welcome to the best anime site.
            </h6>
            <div className="max-w-92.5 pt-2.5">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                ...
                >
                  <img
                    className="brightness-0 max-sm:h-5 max-sm:w-5 dark:invert"
                    src={insta}
                    alt="instagram"
                  />
        ...
        <p className="mb-3 pt-5 text-[12px]">
